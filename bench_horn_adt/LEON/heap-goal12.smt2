...
; conjecture
(assert (forall ((x Heap) (l Lst) (v Int) (m Lst) (k Lst) (ms Int) (ks Int))
	(=> (and (hasLeftistProperty x true) (qheapsorta x (cons v l) m) (qheapsorta x l k)
		(len m ms) (len k ks) (not (= ms (+ 1 ks)))) false)))
